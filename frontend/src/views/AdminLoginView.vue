  ...
  >
    ...
    <div class="relative z-10 grid w-full max-w-6xl items-center gap-8 lg:grid-cols-[1.05fr_0.95fr]">
      <section class="hidden space-y-8 lg:block">
        ...
        <div class="space-y-5">
          <h1 class="max-w-2xl text-5xl font-black tracking-tight md:text-6xl">
            ...
            <span class="block bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-700 bg-clip-text text-transparent dark:from-blue-300 dark:via-indigo-300 dark:to-purple-300">
              Tracer Study UII Dalwa.
            </span>
          </h1>
          <p class="max-w-xl text-lg leading-8 text-slate-600 dark:text-slate-300">
            Akses dashboard admin untuk mengelola kuesioner, memantau
      ...
      <CardHeader class="space-y-1 text-center">
        ...
        <CardTitle
          class="bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-700 bg-clip-text text-3xl font-black tracking-tight text-transparent dark:from-blue-300 dark:via-indigo-300 dark:to-purple-300"
        >
          Portal Admin
        </CardTitle>
      ...
      <CardContent>
        <form @submit.prevent="handleLogin" class="space-y-4">
          ...
          <Button
            type="submit"
            class="h-12 w-full rounded-2xl bg-gradient-to-r from-blue-600 to-indigo-600 text-white shadow-lg shadow-blue-700/20 hover:from-blue-700 hover:to-indigo-700 dark:from-blue-400 dark:to-indigo-400 dark:text-blue-950 dark:hover:from-blue-300 dark:hover:to-indigo-300"
