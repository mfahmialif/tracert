...
<template>
  ...
  >
    <div class="pointer-events-none fixed inset-0 z-0 overflow-hidden">
      ...
      />
      <div
        class="ambient-blob ambient-blob-one absolute left-[8%] top-[18%] h-[22rem] w-[34rem] rotate-[-10deg] rounded-full bg-emerald-500/12 blur-[110px] dark:bg-emerald-400/12 hidden md:block"
      />
      <div
        class="ambient-blob ambient-blob-two absolute right-[6%] top-[8%] h-[20rem] w-[28rem] rotate-[18deg] rounded-full bg-teal-400/10 blur-[110px] dark:bg-cyan-400/8 hidden md:block"
      />
      <div
        class="ambient-blob ambient-blob-three absolute bottom-[8%] left-[35%] h-[18rem] w-[32rem] rounded-full bg-slate-900/7 blur-[120px] dark:bg-blue-700/12 hidden md:block"
      />
      <div
